...
func load_game( slot : int ) -> void:
	...
	var scene_path : String = save_data.get( "scene_path", "res://levels/00_forest/01.tscn" )
...
func save_configuration() -> void:
	...
	config.set_value( "audio", "master", AudioServer.get_bus_volume_linear( 0 ) )
...
func load_configuration() -> void:
	...
	if err != OK:
		...
		return
	AudioServer.set_bus_volume_linear( 0, config.get_value( "audio", "master", 1.0 ) )
